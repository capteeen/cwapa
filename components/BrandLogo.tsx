...
export default function BrandLogo({
  ...
  return (
    ...
    >
      <BrandMark className="h-8 w-8 shrink-0 text-[#202024] drop-shadow-[0_4px_12px_rgba(0,0,0,.16)]" />
      <span className={`text-[20px] font-semibold tracking-[-0.055em] ${wordmark}`}>cwapa</span>
    </Link>
  );
}
